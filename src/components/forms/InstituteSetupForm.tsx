...
// Updated schema with required fields and new fields
const setupFormSchema = z.object({
  name: z
    .string()
    .min(5, { message: "Institute name must be at least 5 characters." }),
  ...
  principalName: z.string().min(3, { message: "Principal name is required" }),
  foundedYear: z
    .string()
    .regex(/^\d{4}$/, { message: "Please enter a valid year (e.g., 2010)" }),
  accreditationInfo: z
    .string()
    .min(1, { message: "Accreditation information is required" }),
...
export function InstituteSetupForm({
  ...
  const form = useForm<z.infer<typeof setupFormSchema>>({
    ...
    defaultValues: {
      ...
      accreditationInfo: "",
      role: "PRINCIPAL", // Default to PRINCIPAL
    },
  });
  ...
  return (
    <Form {...form}>
      ...
      >
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                <FormLabel>Institute Code *</FormLabel>
                <FormControl>
                  <Input placeholder="e.g., pit-mumbai" {...field} required />
                </FormControl>
                <FormDescription>
                  Unique identifier (lowercase letters, numbers, hyphens).
                  Cannot be changed later. Used in URLs.
                </FormDescription>
                <FormMessage />
              </FormItem>
            )}
        ...
        <div className="space-y-4">
          <h3 className="text-lg font-medium">Principal Details</h3>
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormControl>
                  <Input value="PRINCIPAL" disabled {...field} />
                </FormControl>
                <FormDescription>
                  Default role for the first user is set to Principal
                </FormDescription>
                <FormMessage />
              </FormItem>
            )}
